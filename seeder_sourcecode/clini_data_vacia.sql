CREATE DATABASE  IF NOT EXISTS `predict_health_db` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `predict_health_db`;
-- MySQL dump 10.13  Distrib 8.0.41, for Win64 (x86_64)
--
-- Host: localhost    Database: predict_health_db
-- ------------------------------------------------------
...
--
-- Dumping data for table `tbb_actividad_fisica`
--

LOCK TABLES `tbb_actividad_fisica` WRITE;
/*!40000 ALTER TABLE `tbb_actividad_fisica` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbb_actividad_fisica` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `tbb_alertas`
--

LOCK TABLES `tbb_alertas` WRITE;
/*!40000 ALTER TABLE `tbb_alertas` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbb_alertas` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `tbb_mediciones_cardiacas`
--

LOCK TABLES `tbb_mediciones_cardiacas` WRITE;
/*!40000 ALTER TABLE `tbb_mediciones_cardiacas` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbb_mediciones_cardiacas` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `tbb_perfil_salud`
--

LOCK TABLES `tbb_perfil_salud` WRITE;
/*!40000 ALTER TABLE `tbb_perfil_salud` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbb_perfil_salud` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `tbb_smartwatches`
--

LOCK TABLES `tbb_smartwatches` WRITE;
/*!40000 ALTER TABLE `tbb_smartwatches` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbb_smartwatches` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping events for database 'predict_health_db'
--

--
-- Dumping routines for database 'predict_health_db'
--
...
-- Dump completed on 2025-08-18 11:39:51
